...
const ProjectsPage = {
  ...
  async render() {
    ...
    ProjectsPage.state.projects = [...ProjectsPage.MOCK];
  ...
  search(val) {
    ...
    ProjectsPage.state.projects=ProjectsPage.MOCK.filter(p=>
  ...
  filterStatus(s) {
    ...
    ProjectsPage.state.projects=s==='all'?[...ProjectsPage.MOCK]:ProjectsPage.MOCK.filter(p=>p.status===s);
    ProjectsPage.renderPage();
  },
};
