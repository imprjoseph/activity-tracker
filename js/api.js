...
const API = (() => {
  ...
  const MOCK = {
    ...
    vendors: [
      { id:'V001', name:'富立音響工程有限公司',      taxId:'11223344', category:'音響',              status:'配合中', region:'台北市', rating:4.8, projects:15, contact:'王志明', phone:'02-2345-6789', tags:['高品質','推薦'],   notes:'主要音響廠商，有自有設備庫' },
      { id:'V002', name:'聲動音響科技',              taxId:'22334400', category:'音響',              status:'備用',   region:'新北市', rating:4.2, projects:6,  contact:'林建宏', phone:'02-8901-2233', tags:['中型活動'],        notes:'' },
      { id:'V003', name:'光影視覺股份有限公司',      taxId:'22334455', category:'燈光',              status:'配合中', region:'台北市', rating:4.5, projects:12, contact:'李美華', phone:'02-3456-7890', tags:['穩定','推薦'],     notes:'有 LED 洗牆燈等專業設備' },
      { id:'V004', name:'炫彩燈光工程',              taxId:'33400055', category:'燈光',              status:'配合中', region:'桃園市', rating:4.3, projects:8,  contact:'陳俊安', phone:'03-456-7890',  tags:[],                  notes:'' },
      { id:'V005', name:'全視野直播技術',            taxId:'44556677', category:'視訊 / LED',        status:'配合中', region:'台北市', rating:4.3, projects:8,  contact:'張文彬', phone:'02-4567-8901', tags:['4K直播','推薦'],   notes:'4K多機切換，有 LED 大螢幕' },
      { id:'V006', name:'捷勝舞台設計工程',          taxId:'33445566', category:'展場搭建',          status:'配合中', region:'桃園市', rating:4.6, projects:20, contact:'陳建志', phone:'03-234-5678',  tags:['大型活動','推薦'], notes:'' },
      { id:'V007', name:'全彩數位印刷',              taxId:'77889900', category:'印刷輸出',          status:'配合中', region:'新北市', rating:4.4, projects:25, contact:'楊文龍', phone:'02-7890-1234', tags:['快速交件'],        notes:'' },
      { id:'V008', name:'豐群人力派遣',              taxId:'66778899', category:'工讀生 / 活動人力', status:'配合中', region:'全台',   rating:4.0, projects:30, contact:'黃建明', phone:'02-6789-0123', tags:['彈性','量大'],     notes:'' },
      { id:'V009', name:'力展活動人力',              taxId:'66000099', category:'工讀生 / 活動人力', status:'備用',   region:'台北市', rating:3.8, projects:10, contact:'吳佳儀', phone:'02-5678-9999', tags:[],                  notes:'' },
      { id:'V010', name:'林雅涵 司儀工作室',         taxId:'',         category:'司儀 / 主持人',     status:'配合中', region:'台北市', rating:4.9, projects:22, contact:'林雅涵', phone:'0912-345-678', tags:['推薦','中英雙語'], notes:'曾主持總統府活動' },
      { id:'V011', name:'陳志偉 主持人',             taxId:'',         category:'司儀 / 主持人',     status:'配合中', region:'台北市', rating:4.6, projects:15, contact:'陳志偉', phone:'0923-456-789', tags:['科技活動'],        notes:'擅長科技論壇' },
      { id:'V012', name:'翻騰口譯有限公司',          taxId:'55667788', category:'口譯 / 翻譯',       status:'配合中', region:'台北市', rating:4.7, projects:10, contact:'林語涵', phone:'02-5678-9012', tags:['推薦','英日韓'],   notes:'同步口譯設備齊全' },
      { id:'V013', name:'全球通譯服務',              taxId:'55000088', category:'口譯 / 翻譯',       status:'備用',   region:'台北市', rating:4.3, projects:5,  contact:'謝文翰', phone:'02-4567-3333', tags:['英中'],            notes:'' },
      { id:'V014', name:'藍鯊攝影工作室',            taxId:'88990011', category:'攝影',              status:'配合中', region:'台北市', rating:4.9, projects:18, contact:'許家豪', phone:'02-8901-2345', tags:['高品質','推薦'],   notes:'交件速度快' },
      { id:'V015', name:'陳映辰 攝影師',             taxId:'',         category:'攝影',              status:'配合中', region:'桃園市', rating:4.5, projects:8,  contact:'陳映辰', phone:'0934-567-890', tags:['南部活動'],        notes:'' },
      { id:'V016', name:'動感影像製作有限公司',      taxId:'99001122', category:'影片製作',          status:'配合中', region:'台北市', rating:4.7, projects:12, contact:'吳宗翰', phone:'02-9012-3456', tags:['推薦','宣傳片'],   notes:'快剪當天交件' },
      { id:'V017', name:'視野映畫工作室',            taxId:'',         category:'影片製作',          status:'備用',   region:'台中市', rating:4.2, projects:4,  contact:'賴俊宇', phone:'04-234-5678',  tags:['中部'],            notes:'' },
      { id:'V018', name:'科技力 TechPower (YouTuber)',taxId:'',         category:'YouTuber',          status:'配合中', region:'台北市', rating:4.6, projects:3,  contact:'阿力',   phone:'0956-789-012', tags:['科技','訂閱50萬+'],notes:'專攻科技產業' },
      { id:'V019', name:'政策白話文 (YouTuber)',      taxId:'',         category:'YouTuber',          status:'備用',   region:'台北市', rating:4.4, projects:2,  contact:'小白',   phone:'',             tags:['政府政策'],        notes:'訂閱數20萬+' },
      { id:'V020', name:'台灣科技週刊 Podcast',       taxId:'',         category:'Podcast',           status:'配合中', region:'台北市', rating:4.5, projects:4,  contact:'王大明', phone:'0967-890-123', tags:['科技產業'],        notes:'每集平均5萬下載' },
      { id:'V021', name:'公衛好朋友 Podcast',         taxId:'',         category:'Podcast',           status:'備用',   region:'台北市', rating:4.3, projects:1,  contact:'李醫師', phone:'',             tags:['醫療衛生'],        notes:'' },
      { id:'V022', name:'聯合新聞網 科技線',          taxId:'',         category:'媒體 / 記者',       status:'配合中', region:'台北市', rating:4.0, projects:8,  contact:'張記者', phone:'02-8080-0000', tags:['科技線'],          notes:'' },
      { id:'V023', name:'思維視覺設計工作室',         taxId:'',         category:'平面設計',          status:'配合中', region:'台北市', rating:4.7, projects:14, contact:'蔡依婷', phone:'0945-678-901', tags:['推薦','主視覺'],   notes:'擅長國際會議主視覺' },
    ],
  };
  ...
  async function getContacts(params = {}) {
    if (isDemoMode()) return { success: false, message: 'demo' }; // contacts.js handles fallback
    return call('getContacts', params);
  }

  async function createContact(data) {
    if (isDemoMode()) return { success: true };
    return call('createContact', data);
  }

  // ── Evaluations ──────────────────────────────────────────────
  async function getEvaluations(params = {}) {
    if (isDemoMode()) return { success: false, message: 'demo' }; // settings.js handles fallback
    return call('getEvaluations', params);
  }

  async function createEvaluation(data) {
    if (isDemoMode()) return { success: true };
    return call('createEvaluation', data);
  }
