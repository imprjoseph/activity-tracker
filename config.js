...
const CONFIG = {
  ...
  GAS_ENDPOINT: 'https://script.google.com/macros/s/AKfycbxYGpDVBbrzfvwYOH9HxMa7g84G_5dx23YnE1foTTpNBQVWxojcfj9v_WQmKeZ-jsBQLA/exec',
  ...
  // ── Vendor Categories ─────────────────────────────────────────
  VENDOR_CATEGORIES: [
    '硬體設備', '音響', '燈光', '視訊', '展場搭建', '印刷輸出',
    '平面設計', '直播技術', '口譯翻譯', '活動人力', '交通車輛',
    '餐飲供應', '攝影錄影', '旅宿住宿', '網站開發', '公關媒體',
    '其他'
  ],
